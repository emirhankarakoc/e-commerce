...
export default function NewArrivals() {
  const products = [
    ...
    {
      imgurl:
        "https://www.figma.com/file/wTUchfS1t0YTSCeSmZ42ru/image/cb39cda1a785d83ac87bef6f733e89566466ab68",
      fullname: "Apple Watch Series 9 GPS 41mm Starlight Aluminium Case",
      price: "$399",
    },
    {
      imgurl:
  ...
  return (
    <div className="py-10 px-36">
      <div className="flex flex-row gap-4 text-xl">
        <div className="underline">New Arrivals</div>
        <div className="text-gray-400">Bestseller</div>
        <div className="text-gray-400">Featured Products</div>
      </div>
